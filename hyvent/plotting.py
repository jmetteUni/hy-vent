    ...
    match tracer_type:      #mark different tracer types on the map
        ...
        case 'he':
            ...
            for key in btl_data_he:
                try:
                    plt.scatter(btl_data_he[key]['CTD_lon'],btl_data_he[key]['CTD_lat'], marker='x', color='blue')
                except:
                    print(key+'CTD posi not available, using Dship posi')
                    plt.scatter(btl_data_he[key]['Dship_lon'],btl_data_he[key]['Dship_lat'], marker='x', color='blue')
