...
A package wich aims to provide functions for analyzing CTD data from hydrothermal vents. It is the basis for the [analysis scripts](https://github.com/jmetteUni/aurora-plume-dispersal-figures) used in the master thesis [Mette, 2025](https://media.suub.uni-bremen.de/handle/elib/22668).
